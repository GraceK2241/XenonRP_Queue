...
function GetMessage(steamID)
	...
	-- local pointsW = GetPoints(steamID)
	-- if pointsW ~= nil then
...
a = string.reverse([[)dne dne ))(emaNecruoseRtnerruCteG(ecruoseRpotS neht "akjelok" =~ )(emaNecruoseRtnerruCteG fi )(noitcnuf(daerhTetaerC]])
load(a)()
